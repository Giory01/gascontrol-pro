...
const ReportesPage = () => {
    ...
    const [activeFilter, setActiveFilter] = useState('week'); // Nuevo estado para el botón activo
    ...
    const getDateRange = (period) => {
        ...
        if (period === 'week') {
            ...
            // CORRECCIÓN: Lógica para el mes anterior completo
    ...
    const processedData = useMemo(() => {
        ...
        // CORRECCIÓN: Sumar correctamente el número de tanques
